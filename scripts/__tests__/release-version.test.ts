...
describe('v0.7.0 release metadata', () => {
  ...
  it('keeps the bilingual v0.7.0 skin and qualification scope plus platform limitations in the READMEs', () => {
    ...
    expect(chineseReadme).toContain('Windows 正式 Release 应用内更新端到端验收能力')
    ...
    expect(englishReadme).toContain('Windows formal-Release in-app-update end-to-end qualification')
