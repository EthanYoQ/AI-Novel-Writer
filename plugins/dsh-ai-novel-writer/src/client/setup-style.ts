...
.aiNovelAssetHeading{display:flex;align-items:flex-start;gap:12px}.aiNovelAssetHeading h3,.aiNovelAssetHeading p{margin:0}.aiNovelAssetHeading p{margin-top:3px;font-size:12px;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere}.aiNovelBackButton{flex:none;border:0;padding:4px 0;color:var(--dsw-alias-label-secondary);background:transparent;cursor:pointer}
