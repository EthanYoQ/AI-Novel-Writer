...
AI小说作家是 GPL-3.0 的本地优先 AI 写作和小说创作工具，面向中文网文、长篇小说和故事项目作者。它既是 AI 写小说的桌面工作台，也是管理大纲、角色、世界观、章节蓝图、正文生成、审稿修稿、知识库检索和参考小说拆解的本地小说写作软件。

搜索意图：适合正在找 AI写作、AI写小说、AI小说、小说创作工具、网文写作工具和本地写小说软件的创作者。
...
典型场景：从一个故事脑洞开始生成长篇大纲和角色卡；按章节蓝图写正文；用审稿报告驱动修稿；把参考资料、设定和已写章节放入知识库，让后续章节持续读取上下文。
