...
vi.mock('../controllers/external-ai-audit-controller', () => ({ registerExternalAiAuditController: vi.fn() }))
vi.mock('../controllers/external-ai-audit-file-controller', () => ({ registerExternalAiAuditFileController: vi.fn() }))
