...
/** Single source of baseline tables; no data backfill or session fencing. */
export function applyBaselineTables(db: BetterSqlite3.Database): void {
  db.exec(`
    -- ============================================================
...
/** Legacy normalization is used only for new empty databases and explicit legacy fixtures. */
export function initializeLegacyBaselineSchema(db: BetterSqlite3.Database, importSourceSecret?: Buffer) {
  applyBaselineTables(db)
