-- v1.1.0 real old writer schema0 only; no author rows or secrets.
-- Source DB SHA256: 7c9c3c62828c1340def2feae027529a9da8364967879136414be0039bc87a3ad
-- sqlite_master fingerprint: 1207fd8203e31503e3cd09ba5b60a959c606ded34a8c8c7774a9e15edc8271ba
...
CREATE TABLE continuity_projection_meta (
      id TEXT PRIMARY KEY CHECK (id = 'main'),
...
CREATE TABLE drafts (
      ...
      created_at TEXT DEFAULT (datetime('now')),
      updated_at TEXT DEFAULT (datetime('now')), source_dependencies TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE summary_snapshots (
      ...
      character_states TEXT DEFAULT '',
      created_at TEXT DEFAULT (datetime('now'))
    , draft_id INTEGER DEFAULT NULL REFERENCES drafts(id) ON DELETE CASCADE, chapter_notes TEXT NOT NULL DEFAULT '', continuity_facts TEXT NOT NULL DEFAULT '[]', character_state_candidates TEXT NOT NULL DEFAULT '[]', source_finalization_id TEXT NOT NULL DEFAULT '', source_content_hash TEXT NOT NULL DEFAULT '', projection_generation INTEGER NOT NULL DEFAULT 0);
